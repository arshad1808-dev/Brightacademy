...
export default function FloatingWhatsApp() {
  const message = encodeURIComponent("Hi BrightRise Academy, I would like to know more about your 1-on-1 tutoring classes.");
  const whatsappUrl = `https://wa.me/${site.whatsapp}?text=${message}`;

  return (
    <aside aria-label="WhatsApp quick chat" className="floating-whatsapp-container">
      <a
        href={whatsappUrl}
        target="_blank"
